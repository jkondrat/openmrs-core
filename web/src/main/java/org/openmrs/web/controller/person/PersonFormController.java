...
public class PersonFormController extends SimpleFormController {
	...
	protected void updatePersonAddresses(HttpServletRequest request, Person person, BindException errors)
		...
		if (add1s != null || add2s != null || cities != null || states != null || countries != null || lats != null
			...
			for (int i = 0; i < maxAddrs; i++) {
				...
				if (!this.ifAllRequiredAddressFieldFilled(pa, errors))
					return;
			...
			while (addresses.hasNext()) {
                ...
                //check if all required addres fields are filled
                if(!ifAllRequiredAddressFieldFilled(currentAddress,errors))
                    return;
	...
	/**
	 * check if all required address fields re filled
	 * @param errors
	 * @return
	 */
	public static boolean ifAllRequiredAddressFieldFilled(PersonAddress pa, Errors errors) {
